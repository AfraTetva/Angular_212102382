...
export class CuacaComponent implements OnInit, AfterViewInit {
  ...
  bind_table1(): void {
    this.http
      .get(
        'https://api.openweathermap.org/data/2.5/forecast?id=1630789&appid=5ab3c7607d82eb492cb42d97d2b55340'
      )
      .subscribe((data: any) => {
        console.log(data);
        ...
        list.forEach((element: any) => {
          ...
          var caucaDeskripsi = weather.main + '||' + weather.description;
          ...
          var row = [element.dt_txt, iconUrl, caucaDeskripsi, temp];
